...
///
/// Banner y rewarded ya tienen ID real para Android, pero en modo debug se
/// sigue forzando el ID de prueba: servir el anuncio real de la cuenta
/// durante el desarrollo cuenta como tráfico inválido para AdMob y puede
/// llevar a que suspendan la cuenta. El ID real solo se usa en builds de
/// release.
///
